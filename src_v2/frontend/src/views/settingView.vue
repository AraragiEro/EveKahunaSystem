...
const haveAlphaRole = computed(() => authStore.user?.roles.includes('vip_alpha') || false)
...
<template>
  <SidebarLayout :aside-width="220" :menu-items="menuItems" :sidebar-component="settingSidebar">
    <router-view />
  </SidebarLayout>
</template>
